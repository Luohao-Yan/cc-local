...
const translations: Record<UILanguage, Record<string, string>> = {
  en: {
    ...
    "command.description.agents-platform": "Agents platform (stub)",
    "command.description.assistant": "Assistant (stub)",
    "command.description.bridge-kick": "Inject bridge failure states for manual recovery testing",
    "command.description.output-style": "Deprecated: use /config to change output style",
    "command.description.plan": "Enable plan mode or view the current session plan",
    "command.description.pr-comments": "Get comments from a GitHub pull request",
    "command.description.privacy-settings": "View and update your privacy settings",
    "command.description.proactive": "Toggle proactive autonomous mode",
    "command.description.rate-limit-options": "Show options when rate limit is reached",
    "command.description.remote-env": "Configure the default remote environment for teleport sessions",
    "command.description.rename": "Rename the current conversation",
    "command.description.review": "Review a pull request",
    "command.description.reload-plugins": "Activate pending plugin changes in the current session",
    "command.description.session": "Show remote session URL and QR code",
    "command.description.skills": "List available skills",
    "command.description.stats": "Show your Claude Code usage statistics and activity",
    "command.description.stickers": "Order Claude Code stickers",
    "command.description.tag": "Toggle a searchable tag on the current session",
    "command.description.tasks": "List and manage background tasks",
    "command.description.theme": "Change the theme",
    "command.description.think-back": "Your 2025 Claude Code Year in Review",
    "command.description.thinkback-play": "Play the thinkback animation",
    "command.description.ultrareview": "~10-20 min · Finds and verifies bugs in your branch. Runs in Claude Code on the web.",
    "command.description.upgrade": "Upgrade to Max for higher rate limits and more Opus",
    "command.description.release-notes": "View release notes",
    "command.description.plugin": "Manage Claude Code plugins",
  ...
  zh: {
    ...
    "command.description.agents-platform": "代理平台（存根）",
    "command.description.assistant": "助手（存根）",
    "command.description.bridge-kick": "注入桥接故障状态以进行手动恢复测试",
    "command.description.output-style": "已弃用：使用 /config 更改输出样式",
    "command.description.plan": "启用计划模式或查看当前会话计划",
    "command.description.pr-comments": "获取 GitHub 拉取请求的评论",
    "command.description.privacy-settings": "查看和更新您的隐私设置",
    "command.description.proactive": "切换主动自主模式",
    "command.description.rate-limit-options": "达到速率限制时显示选项",
    "command.description.remote-env": "配置传送会话的默认远程环境",
    "command.description.rename": "重命名当前对话",
    "command.description.review": "审查拉取请求",
    "command.description.reload-plugins": "在当前会话中激活待处理的插件更改",
    "command.description.session": "显示远程会话 URL 和二维码",
    "command.description.skills": "列出可用技能",
    "command.description.stats": "显示您的 Claude Code 使用统计和活动",
    "command.description.stickers": "订购 Claude Code 贴纸",
    "command.description.tag": "在当前会话上切换可搜索标签",
    "command.description.tasks": "列出并管理后台任务",
    "command.description.theme": "更改主题",
    "command.description.think-back": "您的 2025 Claude Code 年度回顾",
    "command.description.thinkback-play": "播放回顾动画",
    "command.description.ultrareview": "约 10-20 分钟 · 查找并验证分支中的错误。在 Claude Code 网页版中运行。",
    "command.description.upgrade": "升级到 Max 以获得更高的速率限制和更多 Opus",
    "command.description.release-notes": "查看发行说明",
    "command.description.plugin": "管理 Claude Code 插件",
