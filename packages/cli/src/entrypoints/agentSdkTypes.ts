/**
 * Main entrypoint for Claude Code Agent SDK.
 *
 * Re-exports all types from sdk/ subdirectory.
 * Function implementations live in agentSdkImpl.ts.
 */
...
// Re-export all implementations from the impl module
export {
  tool,
  createSdkMcpServer,
  AbortError,
...
} from './agentSdkImpl.js'

// ============================================================================
// Internal daemon types — kept here for type-only consumers
// ============================================================================
...
/**
 * A user message typed on claude.ai.
 * @internal
 */
