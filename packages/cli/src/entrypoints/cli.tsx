...
// Export main for programmatic use (called by index.ts when not the direct entrypoint)
// When running directly (bun src/entrypoints/cli.tsx), call main() at top level
export { main };

// Auto-execute when run as direct entrypoint (not when imported)
// Use require.resolve to detect if this is the main module
const isDirectEntry = typeof require !== 'undefined' && require.main === module;
if (isDirectEntry || !process.env.CCLOCAL_IMPORTED) {
  void main();
}
