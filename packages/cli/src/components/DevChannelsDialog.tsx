...
export function DevChannelsDialog(t0) {
  ...
  if ($[2] === Symbol.for("react.memo_cache_sentinel")) {
    t2 = <Text>{t('devChannels.warning')}</Text>;
    t3 = <Text>{t('devChannels.useChannels')}</Text>;
    $[2] = t2;
    $[3] = t3;
  } else {
    t2 = $[2];
  ...
  let t5;
  if ($[6] !== t4) {
    t5 = <Box flexDirection="column" gap={1}>{t2}{t3}<Text dimColor={true}>{t('devChannels.channels')}{t4}</Text></Box>;
    $[6] = t4;
    $[7] = t5;
  } else {
    t5 = $[7];
  ...
  if ($[8] === Symbol.for("react.memo_cache_sentinel")) {
    t6 = [{
      label: t('devChannels.localDev'),
      value: "accept"
    }, {
      label: t('devChannels.exit'),
      value: "exit"
    }];
    $[8] = t6;
  } else {
  ...
  let t8;
  if ($[11] !== t5 || $[12] !== t7) {
    t8 = <Dialog title={t('devChannels.title')} color="error" onCancel={handleEscape}>{t5}{t7}</Dialog>;
    $[11] = t5;
    $[12] = t7;
    $[13] = t8;
  } else {
