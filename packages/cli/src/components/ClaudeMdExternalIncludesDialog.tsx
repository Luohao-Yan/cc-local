...
export function ClaudeMdExternalIncludesDialog(t0) {
  ...
  if ($[5] === Symbol.for("react.memo_cache_sentinel")) {
    t6 = <Text>{t('claudeMd.externalImportWarning')}</Text>;
    $[5] = t6;
  } else {
    t6 = $[5];
  }
  ...
  if ($[6] !== externalIncludes) {
    t7 = externalIncludes && externalIncludes.length > 0 && <Box flexDirection="column"><Text dimColor={true}>{t('claudeMd.externalImportsLabel')}</Text>{externalIncludes.map(_temp4)}</Box>;
    $[6] = externalIncludes;
    $[7] = t7;
  } else {
    t7 = $[7];
  ...
  if ($[8] === Symbol.for("react.memo_cache_sentinel")) {
    t8 = <Text dimColor={true}>{t('claudeMd.securityRisk')}{" "}<Link url="https://code.claude.com/docs/en/security" />{" "}</Text>;
    $[8] = t8;
  } else {
    t8 = $[8];
  }
  ...
  if ($[9] === Symbol.for("react.memo_cache_sentinel")) {
    t9 = [{
      label: t('claudeMd.yesAllowExternal'),
      value: "yes"
    }, {
      label: t('claudeMd.noDisableExternal'),
      value: "no"
    }];
    $[9] = t9;
  } else {
  ...
  if ($[12] !== handleEscape || $[13] !== t10 || $[14] !== t4 || $[15] !== t5 || $[16] !== t7) {
    t11 = <Dialog title={t('claudeMd.externalImportTitle')} color="warning" onCancel={handleEscape} hideBorder={t4} hideInputGuide={t5}>{t6}{t7}{t8}{t10}</Dialog>;
    $[12] = handleEscape;
    $[13] = t10;
    $[14] = t4;
    $[15] = t5;
