...
export function ThemePicker(t0: ThemePickerProps) {
  const $ = _c(59);
  const {
    onThemeSelect,
    showIntroText: t1,
  ...
  let t21;
  if ($[35] !== columns) {
    { const SD = StructuredDiff as any; t21 = <Box flexDirection="column" borderTop={true} borderBottom={true} borderLeft={false} borderRight={false} borderStyle="dashed" borderColor="subtle"><SD patch={t20} dim={false} filePath="demo.js" firstLine={null} width={columns} /></Box>; }
    $[35] = columns;
    $[36] = t21;
  } else {
    t21 = $[36];
