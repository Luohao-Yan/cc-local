...
export function BypassPermissionsModeDialog(t0) {
  ...
  if ($[3] === Symbol.for("react.memo_cache_sentinel")) {
    t3 = <Box flexDirection="column" gap={1}><Text>{t('bypass.warning')}<Newline />{t('bypass.restriction')}</Text><Text>{t('bypass.responsibility')}</Text><Link url="https://code.claude.com/docs/en/security" /></Box>;
    $[3] = t3;
  } else {
    t3 = $[3];
  }
  ...
  if ($[4] === Symbol.for("react.memo_cache_sentinel")) {
    t4 = [{
      label: t('bypass.noExit'),
      value: "decline"
    }, {
      label: t('bypass.yesAccept'),
      value: "accept"
    }];
    $[4] = t4;
  } else {
  ...
  let t5;
  if ($[5] !== onChange) {
    t5 = <Dialog title={t('bypass.title')} color="error" onCancel={handleEscape}>{t3}<Select options={t4} onChange={value_0 => onChange(value_0 as 'accept' | 'decline')} /></Dialog>;
    $[5] = onChange;
    $[6] = t5;
  } else {
    t5 = $[6];
